    ...
    return (
      ...
      >
        <div>
          {parseInt(item.id) === slideIndex && (
            <img
              className="h-[850px] w-full absolute"
              src={item.img}
              alt="shoes"
            ></img>
          )}
...
<div className="flex absolute border-2  left-[45%]">
...
<div className="">
  <button
    className="border-2 border-black absolute top-[50%] right-4 bg-white rounded-full p-2 hover:bg-green-300"
